...
describe('ProfanityChecker', () => {
  ...
  describe('Constructor and Initialization', () => {
    it('should create an instance with default options', () => {
      expect(checker).toBeInstanceOf(ProfanityChecker);
    });
    ...
    it('should accept custom options', () => {
      const options: Options = {
        ...
        customWords: {
          profanity: ['customword1'],
          sexual: ['customword2'],
          violence: ['customword3'],
          hateSpeech: ['customword4']
        },
        severity: {
          profanity: 'high',
          sexual: 'high',
      ...
      const customChecker = new ProfanityChecker(options);
      expect(customChecker).toBeInstanceOf(ProfanityChecker);
    });
  });
  ...
  describe('check() method', () => {
    ...
    it('should handle empty or null input', () => {
      ...
      const result2 = checker.check(null as any);
      const result3 = checker.check(undefined as any);
    ...
    it('should handle non-string input', () => {
      const result = checker.check(123 as any);
      expect(result.isFlagged).toBe(false);
  ...
  describe('censor() method', () => {
    ...
    it('should use custom censor character', () => {
      const customChecker = new ProfanityChecker({ censorCharacter: '#' });
    ...
    it('should handle empty or null input', () => {
      ...
      expect(checker.censor(null as any)).toBe('');
      expect(checker.censor(undefined as any)).toBe('');
    });
  ...
  describe('censorHtml() method', () => {
    ...
    it('should handle empty or null HTML input', () => {
      ...
      expect(checker.censorHtml(null as any)).toBe('');
      expect(checker.censorHtml(undefined as any)).toBe('');
    });
  ...
  describe('addToWhitelist() method', () => {
    ...
    it('should respect allowWhitelist option', () => {
      const noWhitelistChecker = new ProfanityChecker({ allowWhitelist: false });
  ...
  describe('getStats() method', () => {
    it('should return correct statistics', () => {
      ...
      expect(stats.total).toBe(
        stats.profanity + stats.sexual + stats.violence + stats.hateSpeech
      );
    });
  ...
  describe('strictMode functionality', () => {
    it('should detect partial matches in strict mode', () => {
      const strictChecker = new ProfanityChecker({ strictMode: true });
    ...
    it('should not detect partial matches in non-strict mode', () => {
      const normalChecker = new ProfanityChecker({ strictMode: false });
